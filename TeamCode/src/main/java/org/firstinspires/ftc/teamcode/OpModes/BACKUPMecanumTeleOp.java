...
@TeleOp
public class BACKUPMecanumTeleOp extends LinearOpMode {
...
//
//
            driveController.drive(gamepad1.left_stick_x, gamepad1.left_stick_y, gamepad1.right_stick_x, 0.8f + (gamepad1.right_trigger / 5) - (gamepad1.left_trigger / 2));
